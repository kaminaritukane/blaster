...
public:
	...
	*/
	...
	void ShowSniperScopeWiget(bool bShowScope);
...
protected:
	...
	void ReceiveDamage(AActor* DamagedActor, 
		...
		class AController* InstigaterController, 
		AActor* DamageCauser);
...
private:
	...
	*/
	...
	UPROPERTY(EditAnywhere, Category = Combat)
	UAnimMontage* SwapGrenadeMontage;
	...
	*/
	...
	void CheckFallingToDeath(float DeltaTime);
